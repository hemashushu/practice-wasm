(module
  ...
  (import "wasi_snapshot_preview1" "fd_fdstat_get" (func (;3;) (type 3)))
  (import "wasi_snapshot_preview1" "fd_seek" (func (;4;) (type 7)))
  (import "wasi_snapshot_preview1" "fd_write" (func (;5;) (type 8)))
  (import "wasi_snapshot_preview1" "proc_exit" (func (;6;) (type 5)))
  ...
  (func (;13;) (type 2) (param i32 i64 i32) (result i64)
    (local i32)
    local.get 0
    i32.load offset=56
    local.set 3
  ...
  (data (;15;) (i32.const 3436) "\01")
  (data (;16;) (i32.const 3456) "\02\00\00\00\03\00\00\00X\10\00\00\00\04")
  (data (;17;) (i32.const 3480) "\01\00\00\00\00\00\00\00\0a")
  (data (;18;) (i32.const 3536) "`\0d\00\00\00\00\00\00\05")
  (data (;19;) (i32.const 3556) "\01")
  (data (;20;) (i32.const 3576) "\04\00\00\00\03\00\00\00\84\14")
